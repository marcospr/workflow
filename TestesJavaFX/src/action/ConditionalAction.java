 ...
 *
 * <p>
 * <code>ConditionalAction</code> possui uma referência para outra <code>AbstractAction</code>, quem
 * efetivamente implementa a ação. Mas o código dessa ação só será executado quando a condição
 * <code>boolean</code> for satisfatória (<code>true</code>).
 * </p>
 *
 * <p>
 * Para implementar esse componente utilizamos o padrão de projeto <strong>Decorator</strong>.
 * </p>
 *
...
public final class ConditionalAction extends AbstractAction {
	 ...
	 *
	 * @throws <code>IllegalArgumentException</code> caso não tenha ação e/ou condição
	...
	/**
	 * @return Constrói e retorna uma instância de <code>ConditionalAction</code> sem ação e condição
	 *         definida.
	 */
