package br.unicamp.cepetro.unisim.mero.gui.app.action;

/**
 * Componente representa uma ação, normalmente vinculada a intervenção do usuário nos componentes de
 * interface gráfica, para solicitar uma operação ao sistema.
 *
 ** <p>
 * Utiliza o design pattern <code>Template Method</code> para definir um estrutura/template com
 * código complementar (e opcional) a ação:
 * </p>
 * *
 * <ul>
...
public abstract class AbstractAction {
	 ...
	 * <p>
	 * Caso uma exceção (<code>RuntimeException</code>) seja lançada, a execução de toda a
	 * <code>AbstractAction</code> é interrompida.
	 * </p>
	 */
	...
	/**
	 * Método é acionado quando alguma falha ocorre durante a execução de <code>action</code>,
