...
public class RootContainerBackup extends BorderPane {
	...
	private void buildToolbar(final VBox topContainer) {
		...
		Image imageProcess = new Image(getClass().getResourceAsStream("../resources/rounded.png"));
		Image imageStart = new Image(getClass().getResourceAsStream("../resources/start.png"));
		Image imageEnd = new Image(getClass().getResourceAsStream("../resources/end.png"));
		Image imageArrow = new Image(getClass().getResourceAsStream("../resources/arrow.png"));
		Image imageCheck = new Image(getClass().getResourceAsStream("../resources/check.png"));
